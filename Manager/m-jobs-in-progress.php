...
$imageSource = "highway night lights_two.jpg";
$header_two = "Jobs In Progress";
...
$sql = "SELECT job_id, creator_name, assigned_artist FROM tbl_jobs where job_status = 'ongoing' LIMIT $start_from, $results_per_page";
