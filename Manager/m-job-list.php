...
$imageSource = "banner logo.jpg";
$header_two = "Job List Order";
...
$sql = "SELECT job_id, creator_name, time_created, job_brief FROM tbl_jobs where job_status = 'open' LIMIT $start_from, $results_per_page";
