...
<body>
    ...
    <div class="sidebar">
        <img class="companylogo" src="imprint customs logo 1.png">
            <h3><a id="dashboard_link" href="agent_home.php">Agent Dashboard</a></h3>
            <ul>
                <li><a id="sidebar_link" href="agent_home.php"><i class="fa-solid fa-plus"></i> Job Creation</a></li>
                <li><a id="sidebar_link" href="agent_joblist.php"><i class="fa-solid fa-list"></i> Job List</a></li>
            </ul>
    </div>
